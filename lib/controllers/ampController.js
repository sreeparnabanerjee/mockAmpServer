...
module.exports.getFeedSubmissionList = function (req, res, next, bucket) {
...
module.exports.submitFeed = function (req, res, next, bucket) {
  console.log(req.method + ' ' + req.url);
  var dateFormat = 'ddd, DD MMM YYYY HH:mm:ss [GMT]';
  var resultDate = new Date();
  var reset = moment(resultDate).add(1, 'minute').format(dateFormat);
...
module.exports.getFeedSubmissionResult = function (req, res, next, bucket) {
  console.log(req.method + ' ' + req.url);
  var dateFormat = 'ddd, DD MMM YYYY HH:mm:ss [GMT]';
  var resultDate = new Date();
  var reset = moment(resultDate).add(1, 'minute').format(dateFormat);
...
module.exports.sendInvalidParameterValue = function (req, res) {
  console.log(req.method + ' ' + req.url);
  res.setHeader('Content-Type', 'text/xml');
...
module.exports.sendInputStreamDisconnected = function (req, res) {
  console.log(req.method + ' ' + req.url);
  res.setHeader('Content-Type', 'text/xml');
  res.status(400).send(jstoxml.toXML({
    ErrorResponse: {
...
module.exports.sendAccessDenied = function (req, res) {
  console.log(req.method + ' ' + req.url);
  res.setHeader('Content-Type', 'text/xml');
...
module.exports.sendInvalidAccessKeyId = function (req, res) {
  console.log(req.method + ' ' + req.url);
  res.setHeader('Content-Type', 'text/xml');
...
module.exports.sendSignatureDoesNotMatch = function (req, res) {
  console.log(req.method + ' ' + req.url);
  res.setHeader('Content-Type', 'text/xml');
  res.status(403).send(jstoxml.toXML({
    ErrorResponse: {
...
module.exports.sendInvalidAddress = function (req, res) {
  console.log(req.method + ' ' + req.url);
  res.setHeader('Content-Type', 'text/xml');
...
module.exports.sendInternalError = function (req, res) {
  console.log(req.method + ' ' + req.url);
  res.setHeader('Content-Type', 'text/xml');
...
module.exports.sendQuotaExceeded = function (req, res) {
  console.log(req.method + ' ' + req.url);
  res.setHeader('Content-Type', 'text/xml');
...
module.exports.sendRequestThrottled = function (req, res, next, bucket) {
  console.log(req.method + ' ' + req.url);
  res.setHeader('Content-Type', 'text/xml');
  res.status(503).send(jstoxml.toXML({
    ErrorResponse: {
